...
- [ ] Complete first year of CSAM with strong results
- [ ] Learn Python data analysis libraries (pandas, numpy, matplotlib)
- [ ] Build a data analysis project using a South African dataset
- [ ] Apply for graduate internship programmes (Standard Bank, Deloitte, Investec)
- [ ] Earn a cloud certification (AWS or Azure fundamentals)

---

## Connect with me

[![GitHub](https://img.shields.io/badge/GitHub-wanda--poti-181717?style=flat&logo=github)](https://github.com/wanda-poti)
